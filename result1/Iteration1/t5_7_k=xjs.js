...
var s_KKa=function(a){return a instanceof s_Bl&&a.ha},s_NKa=function(a,b){if(s_LKa){var c=Date.now();c>=s_MKa&&(s_MKa=c+100,google.log("sts:gws","&e="+a+"&d="+b))}},s_Bl=function(a,b,c){this.ha=!1;this.Ba=a;this.wa=b;this.ka=c||null;this.Aa=!1};s_Bl.prototype.play=function(){var a=this;return new s_3f(function(b){a.finish();b()})};s_Bl.prototype.finish=function(){this.ha||(this.ha=!0,this.ka&&this.ka.isDisposed()?this.Ca=!0:this.wa?this.Ba.apply(this,s_nb(this.wa)):this.Ba())};s_Bl.prototype.Ce=function(){return 0};
var s_LKa=.1>Math.random(),s_MKa=0,s_OKa=function(a,b,c){s_Bl.call(this,a,b);this.id=c};s_n(s_OKa,s_Bl);
var s_PKa=function(){this.Ba=0;this.wa=[];this.ha=null;this.Aa=-1;this.ka=void 0},s_QKa=function(a){window.clearTimeout(a.Aa);a.Aa=-1},s_RKa=function(a){if(!a.ha&&a.wa.length){var b=a.wa.shift();s_QKa(a);a.ha=b;try{var c=b.Cw,d=c.play();c instanceof s_Bl&&c.Ca&&s_NKa("itd",b.method);s_va(d.then(function(){return b.Fj.resolve(null)},function(e){return b.Fj.reject(e)}),function(){a.ha&&b.id!=a.ha.id||(a.ha=null,s_0f(function(){return s_RKa(a)}))});c.Aa||Infinity==c.Ce()||(a.Aa=window.setTimeout(function(){a.Aa=
-1;a.ha&&b.id==a.ha.id&&(s_KKa(b.Cw)||s_NKa("tto",b.method),s_SKa(a))},c.Ce()))}catch(e){google.ml(e,!1,{op:"scheduler:play"}),s_SKa(a)}}},s_SKa=function(a){s_QKa(a);a.ha&&(s_TKa(a.ha),a.ha=null);s_0f(function(){return s_RKa(a)})},s_TKa=function(a){try{a.Cw.finish(),a.Fj.resolve(null)}catch(b){a.Fj.reject(),google.ml(b,!1,{op:"scheduler:finish"})}},s_UKa=function(a,b,c){return{id:++a.Ba,Cw:b,Fj:s_ya(),method:c}};s_PKa.prototype.Gda=function(a){return s_VKa(this,a,1)};
var s_VKa=function(a,b,c){b=s_UKa(a,b,c);a.ka?a.ka.push(b):(a.wa.push(b),s_0f(function(){return s_RKa(a)}));return b.Fj.Pb};s_=s_PKa.prototype;s_.Uea=function(a){a=s_UKa(this,a,2);s_Zb(this.wa,a,0);this.ha&&(s_QKa(this),s_KKa(this.ha.Cw)||s_NKa("pnf",this.ha.method),s_TKa(this.ha),this.ha=null);s_RKa(this);return a.Fj.Pb};s_.flush=function(){if(!this.ka){this.ka=this.wa;this.wa=[];this.ha&&(s_QKa(this),this.ka.unshift(this.ha),this.ha=null);for(;this.ka.length;)s_TKa(this.ka.shift());this.ka=void 0}};
s_.w5=function(a){return s_VKa(this,new s_Bl(a,void 0,void 0),3)};s_.t9=function(a,b){var c=this,d=!1;return function(e){for(var f=[],g=0;g<arguments.length;++g)f[g]=arguments[g];d||(d=!0,c.w5(function(){d=!1}),a.apply(b,f))}};s_.setTimeout=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];var f=this,g=window.setTimeout(function(){s_VKa(f,new s_OKa(a,d,g),4)},b);return new s_mka(g)};
var s_WKa=function(a,b){return s_Sb(a.wa,function(c){c=c.Cw;return c instanceof s_OKa&&c.id==b})};s_PKa.prototype.clearTimeout=function(a){null!=a&&(window.clearTimeout(a.value),a=s_WKa(this,a.value),-1<a&&s__b(this.wa,a))};s_PKa.prototype.clearInterval=function(a){this.clearTimeout(a)};s_PKa.prototype.setInterval=function(a,b,c){for(var d=[],e=2;e<arguments.length;++e)d[e-2]=arguments[e];var f=this,g=window.setInterval(function(){-1<s_WKa(f,g)||s_VKa(f,new s_OKa(a,d,g),5)},b);return new s_mka(g)};
s_kg(s_kka,new s_PKa);
